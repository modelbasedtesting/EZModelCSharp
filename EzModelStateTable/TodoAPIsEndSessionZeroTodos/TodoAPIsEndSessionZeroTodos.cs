...
namespace TodoAPIsEndSessionZeroTodos
{
    class TodoAPIsEndSessionZeroTodosProgram
    {
        static int Main()
        {
            ...
            // maxActions = 35
            EzModelGraph graph = new EzModelGraph(client, 200, 30, 25);
            ...
            graph.RandomDestinationCoverage("TodoAPIsEndSessionZeroTodos", 3);
            return 0;
        }
    }
