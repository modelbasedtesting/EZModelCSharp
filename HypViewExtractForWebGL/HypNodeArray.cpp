...
int HypNodeArray::compareElements(void *e1, void *e2) {
    return(((HypNode*)e1)->compare((HypNode*)e2));
}

int HypNodeDistArray::compareElements(void *e1, void *e2) {
    return(((HypNode*)e1)->compareDist((HypNode*)e2));
}

HypNodeArray::~HypNodeArray()
{
